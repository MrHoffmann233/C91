...
function car1_up(){
	...
	{
		car1Y = car1Y - 10;
		console.log("Quando seta pra cima é pressionado, x = " + car1X + "	| y = " +car1Y);
		uploadBackground();
		 uploadcar1();
		 uploadcar2();
	}
...
function car1_down(){
	...
	{
		car1Y = car1Y + 10;
		console.log("Quando seta pra baixo é pressionado, x = " + car1X + "	| y = " +car1Y);
		uploadBackground();
		 uploadcar1();
		 uploadcar2();
	}
...
function car1_left(){
	...
	{
		car1X = car1X - 10;
		console.log("Quando seta pra esquerda é pressionado, x = " + car1X + "	| y = " +car1Y);
		uploadBackground();
		 uploadcar1();
		 uploadcar2();
	}
...
function car1_right(){
	...
	{
		car1X = car1X + 10;
		console.log("Quando seta pra direita é pressionado, x = " + car1X + "	| y = " +car1Y);
		uploadBackground();
		 uploadcar1();
		 uploadcar2();
	}
...
{
	console.log("car1");
	document.getElementById('gameStatus').innerHTML = "carro 1 vencedor!!";
}
